                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <input aria-label="Nombre" placeholder="Nombre (*)" required type="text" id="nombre" name="nombre" class="form-control form--input" value="{{ old('nombre') }}">
                        </div>
                        <div class="col-12 col-lg mt-md-3 mt-lg-0">
                            <input aria-label="Email" placeholder="Email (*)" required type="email" id="email" name="email" class="form-control form--input" value="{{ old('nombre') }}">
                        </div>
                        <div class="col-12 col-lg mt-md-3 mt-lg-0">
