<div class="modal" id="modalExcel" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('productos.all')); ?>" onsubmit="event.preventDefault(); update( this )" id="formUpdate" method="post">
                <div class="modal-body">
                    ...
                    <div class="modal--modelo my-3">
                        <a href="<?php echo e(asset('modelo.xlsx')); ?>" download class="btn btn-link">Modelo para carga<i class="fas fa-download ml-2"></i></a>
                        <ul>
                            <li><i class="fas fa-folder-open"></i> las imágenes deben estar sueltas en la carpeta <strong><a target="blank" href="<?php echo e(asset('images/productos')); ?>">images/productos</a></strong></li>
                            <li><i class="fas fa-folder-open"></i> las fichas deben estar sueltas en la carpeta <strong><a target="blank" href="<?php echo e(asset('fichas')); ?>">fichas</a></strong></li>
                            <li><i class="fas fa-folder-open"></i> los planos deben estar sueltos en la carpeta <strong><a target="blank" href="<?php echo e(asset('images/planos')); ?>">images/planos</a></strong></li>
                        </ul>
...
<section class="my-3">
    <div class="container-fluid">
        <?php echo $__env->make( 'layouts.general.form' , [ 'buttonADD' => 1 , 'form' => 1 , 'close' => 1 , 'modal' => 1 , "buttons" => [ [ "i" => "fas fa-file-excel" , "t" => "Productos" , "b" => "btn-primary"] ] ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home3/guifer/public_html/laravel/resources/views/auth/parts/categorias.blade.php ENDPATH**/ ?>