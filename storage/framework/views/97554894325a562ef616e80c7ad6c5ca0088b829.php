            ...
            <div class="mt-n4" id="productos-slick">
                <?php $__currentLoopData = $data[ "productos" ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mt-4 hover p-3">
                        <a href="<?php echo e(URL::to( 'producto/' . str_slug( $producto->title ) . '/' . $producto->id )); ?>" class="d-block plus position-relative">
                            <?php if( !empty( $producto->is_nuevo ) ): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/osolelar/hidratools_laravel/resources/views/page/home.blade.php ENDPATH**/ ?>