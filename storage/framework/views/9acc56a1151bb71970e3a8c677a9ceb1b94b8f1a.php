    ...
    <body>
        ...
        <script>
            ...
            changeLanguage = t => {
                ...
                if ($(t).find("option:selected").data("url"))
                    window.location = $(t).find("option:selected").data("url");
                else {
                    let url = window.location.href;
                    url = url.replace(language, $(t).val());
                    window.location = url;
                }
            };
            enviarNewsletter = t => {
...
</html><?php /**PATH /home/pablo/Escritorio/ga-srl/resources/views/layouts/main.blade.php ENDPATH**/ ?>