...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
        ...
        <div id="wrapper-body">
            <?php echo $__env->make( 'layouts.general.header' , [ 'elementos' => $data[ 'empresa' ], 'link' => 1 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <section>
            <?php echo $__env->make( $data[ 'view' ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </section>
            <?php echo $__env->make( 'layouts.general.footer' , [ 'elementos' => $data[ 'empresa' ], 'link' => 1 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- Scripts -->
        ...
        <script>
            ...
            $(function(){
                ...
                $(document).scroll( function() {
                    ...
                    if ( value > 100 && headerIsBig ){
                        $header.addClass("sticky-header-active");
                        headerIsBig = false;
                    } else if (value <= 100 && !headerIsBig ) {
...
</html><?php /**PATH /home/pablo/Escritorio/eurocam/resources/views/layouts/main.blade.php ENDPATH**/ ?>