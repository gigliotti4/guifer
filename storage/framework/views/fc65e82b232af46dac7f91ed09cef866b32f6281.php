<div class="lateral sticky-top">
    ...
    <div class="sidebar collapse dont-collapse-sm" id="accordionMenu">
        ...
        <?php $__currentLoopData = $elementos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make("page.parts.menu", ["dato" => $m, "tipo" => 1, "padre" => null, "idioma" => $idioma], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
    </div>
</div><?php /**PATH /home/pablo/Escritorio/ga-srl/resources/views/page/parts/lateral.blade.php ENDPATH**/ ?>