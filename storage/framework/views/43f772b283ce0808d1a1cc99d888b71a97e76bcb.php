        ...
        <form class="d-block my-5" action="" method="get">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 d-flex">
                    <input pattern="(.|\s)*\S(.|\s)*" value="<?php echo e($data['search']); ?>" name="s" placeholder="Estoy buscando..." type="search" class="form-control form--input form-control-lg mr-3">
...
</div><?php /**PATH /home3/guifer/public_html/laravel/resources/views/page/search.blade.php ENDPATH**/ ?>