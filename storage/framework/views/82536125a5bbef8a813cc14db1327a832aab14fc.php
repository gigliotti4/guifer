<div class="wrapper-productos bg-white pb-5">
    ...
    <div class="container pt-3">
        <ol class="breadcrumb bg-transparent border-0 p-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(URL::to( 'productos/' . str_slug( $data[ 'categoria' ]->title ) )); ?>"><?php echo e($data[ 'categoria' ]->title); ?></a></li>
...
</div><?php /**PATH /home/pablo/Escritorio/hidratools/resources/views/page/subcategoria.blade.php ENDPATH**/ ?>