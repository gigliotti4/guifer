<div class="productos pb-5 pt-3">
    <div class="container">
        <ol class="breadcrumb border-0 rounded-0 bg-white mb-3">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?php echo e($data["marca"]->nombre); ?></li>
        </ol>
        <div class="row">
            ...
            <div class="col-12 col-md-8 col-lg-8">
                ...
                <div class="producto--text">
                    <?php echo $data["marca"]->text[App::getLocale()]; ?>
...
</div><?php /**PATH /home/pablo/Escritorio/ga-srl/resources/views/page/marca.blade.php ENDPATH**/ ?>