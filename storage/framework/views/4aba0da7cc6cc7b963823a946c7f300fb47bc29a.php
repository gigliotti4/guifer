                ...
                <div class="row mt-n4">
                    <?php $__currentLoopData = $data[ "subcategorias" ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 col-md-4 mt-4 hover">
                            ...
                            <?php else: ?>
                            <a href="<?php echo e(URL::to( 'productos/' . str_slug( $data[ 'categoria' ]->title ) . '/'. str_slug( $subcategoria->title ) )); ?>" class="d-block plus">
                                <div class="img">
...
</div><?php /**PATH /home/pablo/Escritorio/hidratools/resources/views/page/categoria.blade.php ENDPATH**/ ?>