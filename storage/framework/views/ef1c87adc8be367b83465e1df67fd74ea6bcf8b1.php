<div class="wrapper-productos bg-white pb-5">
    ...
    <div class="container pt-3">
        <ol class="breadcrumb bg-transparent border-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?php echo e($data[ 'categoria' ]->title); ?></li>
        </ol>
        <div class="row mt-5">
            ...
            <div class="col-12 col-md-8 col-lg-9">
                <div class="row mt-n4">
                    <?php $__currentLoopData = $data[ "subcategorias" ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 col-md-4 mt-4 hover">
                            <?php if( $subcategoria->productos()->count() == 1 ): ?>
                            <?php
                            ...
                            <?php else: ?>
                            <a href="<?php echo e(URL::to( 'productos/' . str_slug( $data[ 'categoria' ]->title ) . '/' . $data[ 'categoria' ]->id . '/'. str_slug( $subcategoria->title ) . '/' . $subcategoria->id )); ?>" class="d-block plus">
                                <div class="img">
                                    <?php echo $__env->make( 'layouts.general.image' , [ 'i' => $subcategoria->image , 'c' => 'd-block w-100 mb-2' , 'n' => $subcategoria->title ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                                <?php if( !empty( $subcategoria->subtitle ) ): ?>
                                <p class="subname"><?php echo e($subcategoria->subtitle); ?></p>
                                <?php endif; ?>
                                <p class="name"><?php echo e($subcategoria->title); ?></p>
                            </a>
                            <?php endif; ?>
                        </div>
                ...
                <div class="row mt-5">
                    <div class="col-12 d-flex justify-content-center">
                        <?php echo e($data[ "subcategorias" ]->links()); ?>
...
</div><?php /**PATH C:\Users\Pablo\Desktop\Laravel\hidratools\resources\views/page/categoria.blade.php ENDPATH**/ ?>