...
<div class="wrapper-productos bg-white pb-5">
    ...
    <div class="container pt-3">
        <ol class="breadcrumb bg-transparent border-0 p-0">
            ...
            <li class="breadcrumb-item breadcrumb-name"><a href="<?php echo e(URL::to( 'productos/' . str_slug( $data[ 'categoria' ]->title ) )); ?>"><?php echo e($data[ 'categoria' ]->title); ?></a></li>
            <?php if( isset( $data[ 'subcategoria' ] ) ): ?>
                <?php if( strcasecmp( $data[ 'subcategoria' ]->title , $data[ 'producto' ]->title ) != 0 ): ?>
                <li class="breadcrumb-item breadcrumb-name"><a href="<?php echo e(URL::to( 'productos/' . str_slug( $data[ 'categoria' ]->title ) . '/' . str_slug( $data[ 'subcategoria' ]->title ) )); ?>"><?php echo e($data[ 'subcategoria' ]->title); ?></a></li>
                <?php endif; ?>
            <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/pablo/Escritorio/hidratools/resources/views/page/producto.blade.php ENDPATH**/ ?>