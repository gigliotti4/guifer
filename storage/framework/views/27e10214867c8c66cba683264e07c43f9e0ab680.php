        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(URL::to('buscar')); ?>" class="wrapper-contacto" method="get">
                <div class="modal-body">
                    ...
                    <input required pattern=".{3,}" placeholder="Buscar productos por título, descripción o contenido en general" type="search" name="search" class="form-control">
                </div>
...
</header><?php /**PATH /home/pablo/Escritorio/hidratools/resources/views/layouts/general/header.blade.php ENDPATH**/ ?>