<div class="wrapper-blogs bg-white pb-5">
    <div class="container pt-3">
        <ol class="breadcrumb bg-transparent border-0 p-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(URL::to( '/novedades' . Str::slug( $data[ 'blog' ]->categoria->title) . '/' . $data[ 'blog' ]->categoria->id )); ?>"><?php echo e($data[ 'blog' ]->categoria->title); ?></a></li>
...
</div><?php /**PATH C:\xampp\htdocs\guifer\resources\views/page/blog.blade.php ENDPATH**/ ?>