<section class="my-3">
    <div class="container-fluid">
        <div class="mb-4">
            <?php echo $__env->make('page.parts.home' , ['elementos' => $data['elementos']->data, 'idioma' => 'es', 'link' => 0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<script>
    ...
    addNumero = ( t , value = null ) => {
        ...
        window.pyrus_numero.show( CKEDITOR , url_simple , value , window[ `numero` ] , "numero" );
    };
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/pablo/Escritorio/ga-srl/resources/views/auth/parts/contenidoHome.blade.php ENDPATH**/ ?>