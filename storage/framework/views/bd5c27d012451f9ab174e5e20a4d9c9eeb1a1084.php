            ...
            <nav class="navbar justify-content-between w-100 navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarNavDropdown">
                    <ul class="navbar-nav px-3">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(URL::to('/')); ?>" class="nav-link" target="blank"><i class="fas mr-2 fa-external-link-alt"></i>Parte pública</a>
                        </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/guifer/public_html/laravel/resources/views/auth/distribuidor.blade.php ENDPATH**/ ?>