                    ...
                    <form id="form" onsubmit="event.preventDefault(); formSubmit(this);" class="pt-2" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="container-form py-3 mt-3">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-12 col-md-7">
                                <input type="email" required name="newsletters" placeholder="Ingrese mail" <?php if(isset($data['elementos']['form']['newsletters'])): ?> value="<?php echo e($data['elementos']['form']['newsletters']); ?>" <?php endif; ?> class="form-control border-top-0 border-left-0 border-right-0 rounded-0">
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/pablo/Escritorio/ga-srl/resources/views/auth/parts/empresaForm.blade.php ENDPATH**/ ?>