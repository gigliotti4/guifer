<section class="my-3">
    <div class="container-fluid">
        <div class="mb-4">
            ...
            <?php echo $__env->make( 'layouts.general.header' , [ 'elementos' => $data[ 'elementos' ], 'link' => 0, 'idioma' => 'es' ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <h3 class="text-center mt-4 mb-3">Pie de página</h3>
            <?php echo $__env->make( 'layouts.general.footer' , [ 'elementos' => $data[ 'elementos' ], 'link' => 0, 'idioma' => 'es' ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/pablo/Escritorio/ga-srl/resources/views/auth/parts/empresa.blade.php ENDPATH**/ ?>