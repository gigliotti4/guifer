...
<div id="<?php echo e($sliderID); ?>" class="carousel slide wrapper-slider" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item <?php if( $i == 0 ): ?> active <?php endif; ?>">
            ...
            ?>
            <?php if($div): ?>
                <div class="<?php echo e($class); ?>" style="background-image: url('<?php echo e(asset($img)); ?>');" >
...
<?php endif; ?><?php /**PATH /home3/guifer/public_html/laravel/resources/views/layouts/general/slider.blade.php ENDPATH**/ ?>