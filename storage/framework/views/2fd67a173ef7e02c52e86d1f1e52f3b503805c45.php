...
<div class="my-2">
    ...
    <button disabled class="btn <?php echo e($d[ 'b' ]); ?> text-center rounded-0">
    ...
    <?php if(isset( $buttons )): ?>
        ...
        <button <?php if(!isset($d['f'])): ?> disabled <?php endif; ?> <?php if(isset($d['f'])): ?> onclick="<?php echo e($d[ 'f' ]); ?>Function( this );" <?php endif; ?> class="btn <?php echo e($d[ 'b' ]); ?> text-center rounded-0">
            <i class="<?php echo e($d[ 'i' ]); ?>" aria-hidden="true"></i> <?php echo e($d[ 't' ]); ?>
...
<?php endif; ?><?php /**PATH /home3/guifer/public_html/laravel/resources/views/layouts/general/form.blade.php ENDPATH**/ ?>