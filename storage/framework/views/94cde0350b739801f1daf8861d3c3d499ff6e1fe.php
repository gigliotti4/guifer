...
<script>
    ...
    formSubmit = ( t ) => {
        ...
        formData.append( "ATRIBUTOS", JSON.stringify(
            [
                ...
                { DATA: window.pyrusText.objetoSimple, TIPO: "U", COLUMN: "texto" },
    ...
    addTelefono = ( t, value = null ) => {
        ...
        window.pyrusTelefono.show( null , url_simple , value , window[ `telefono` ] , `telefono` );
    };
    ...
    init = ( callbackOK ) => {
        form = "";
        /** */
        form += `<div class="form-label-group mb-4">`;
            form += `<input value="${window.data.elementos.horario}" name="horario" id="horario" class="form-control bg-transparent border-top-0 border-left-0 border-right-0 rounded-0 form-adm" type="text" placeholder="HORARIO">`;
            form += `<label for="horario" class="form-adm">HORARIO</label>`;
        form += `</div>`;
    ...
    init( () => {
        ...
        window.pyrusText.show( null , url_simple , window.data.elementos.texto );
        ...
        window.data.elementos.telefono.forEach( ( t ) => {
            addTelefono( $( "#btnTelefono" ) , t );
        });
    });
</script>
<?php $__env->stopPush(); ?><?php /**PATH /home/pablo/Escritorio/eurocam/resources/views/auth/parts/empresa.blade.php ENDPATH**/ ?>